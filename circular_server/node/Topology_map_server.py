...
class TopologyMapAction():
    _result = circular_server.msg.TopologyMapResult()
    _feedback = circular_server.msg.TopologyMapFeedback()
    ...
    def __init__(self, name):
        ...
        self._as = actionlib.SimpleActionServer(self._action_name, circular_server.msg.TopologyMapAction, execute_cb=self.execute_cb, auto_start = False)
        self._as.start()
