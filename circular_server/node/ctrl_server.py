...
from circular_server.msg import PBVSFoundationposeAction, PBVSFoundationposeGoal, TopologyMapAction, TopologyMapGoal
from geometry_msgs.msg import PoseStamped

def PBVS_client(msg):
    client = actionlib.SimpleActionClient('PBVS_server', PBVSFoundationposeAction)
    rospy.loginfo("Waiting for PBVS_server...")
    client.wait_for_server()
    command = PBVSFoundationposeGoal(command=msg[1], layer_dist=msg[2])
    print("send ", command)
